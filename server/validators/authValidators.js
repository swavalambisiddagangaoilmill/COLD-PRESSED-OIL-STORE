...
export const requestOtpValidator = [email, body("purpose").optional().isIn(["signup", "login"]).withMessage("Invalid authentication purpose."), body("name").optional().trim().isLength({ min: 2, max: 100 }).withMessage("Enter your full name.")];
