...
export const adminApi = {
  ...
  deleteCategory: (id) => apiRequest(`${base}/categories/${id}`, { method: "DELETE" }),
  ...
  navbar: () => apiRequest(`${base}/navbar`),
  saveNavbar: (payload) => apiRequest(`${base}/navbar`, { method: "PUT", body: JSON.stringify(payload) }).then((result) => { window.dispatchEvent(new Event("ss-oil-mill-navbar-changed")); return result; }),
