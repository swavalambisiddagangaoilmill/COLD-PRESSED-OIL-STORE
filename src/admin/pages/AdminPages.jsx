...
function OrderDetailsDrawer({ order, onClose, onAction, pending, shiprocketAvailable }) {
  ...
  const transaction = order.cfPaymentId || order.cashfreeOrderId || order.razorpayPaymentId || order.razorpayOrderId;
...
export function PaymentsPage() { return <SimpleList title="Payments" description="Review payment methods and statuses." loader={adminApi.payments} columns={["Payment ID", "Order", "Customer", "Method", "Amount", "Status"]} row={(o) => [o.cfPaymentId || o.razorpayPaymentId || `COD-${o._id}`, o._id, o.user?.name || "-", o.paymentMethod, money(o.totalAmount), o.paymentStatus]} />; }
