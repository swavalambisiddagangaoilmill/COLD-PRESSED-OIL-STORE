...
const SEARCH_TERMS = [
  "Groundnut Oil", "Coconut Oil", "White Sesame Oil", "Black Sesame Oil",
  "Mustard Oil", "Sunflower Oil", "Safflower Oil", "Flaxseed Oil",
  "Niger Seed Oil", "Badam Oil", "Castor Oil", "Neem Oil", "Caranja Oil",
  "Herbal Oil", "Cold Pressed Oil", "Cooking Oil", "Specialty Oil",
];
