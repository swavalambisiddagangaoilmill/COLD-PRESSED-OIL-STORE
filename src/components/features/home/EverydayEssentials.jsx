...
export default function EverydayEssentials() {
  ...
  useEffect(() => {
    ...
    getEverydayEssentials()
      .then((items) => active && setEverydayEssentials(items))
      .catch(() => active && setEverydayEssentials([]));
    return () => {
      active = false;
    };
  }, []);
    ...
    <section className="py-12 md:py-16 xl:py-20">
      <Container>
        <SectionHeading
          ...
          text="Slow-pressed oils selected for daily cooking, quiet rituals, and a pantry that feels considered."
        />
